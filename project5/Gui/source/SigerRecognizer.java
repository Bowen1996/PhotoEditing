...
public class SigerRecognizer {
    ...
    public enum PatternIndex {
        FORWARD, PREVIOUS, DELETE, VACATION, WORK, SCHOOL, FAMILY, SELECTION, NONE
    } 

    private final String[] forward = {"RIGHTS_AND_DOWNS", "LEFTS_AND_DOWNS"}; // >
    private final String[] previous = {"LEFTS_AND_DOWNS", "RIGHTS_AND_DOWNS"}; // <
    //private final String[] delete = {"LEFTS_AND_DOWNS", "RIGHTS_AND_DOWNS", "RIGHTS_AND_UPS", "LEFTS_AND_UPS", "RIGHTS_AND_DOWNS"}; //phi symbol
    private final String[] delete = {"DOWNS", "RIGHTS", "UPS", "DOWNS"}; //phi symbol
    private final String[] vacation = {"RIGHTS_AND_DOWNS", "RIGHTS_AND_UPS"}; // v
    private final String[] work = {"RIGHTS_AND_DOWNS", "RIGHTS_AND_UPS","RIGHTS_AND_DOWNS", "RIGHTS_AND_UPS"}; //w
    private final String[] school = {"LEFTS_AND_DOWNS", "RIGHTS_AND_DOWNS", "LEFTS_AND_DOWNS"}; //s
    private final String[] family = {"RIGHTS_AND_UPS", "RIGHTS_AND_DOWNS"}; //^
    private final String[] selection = {"RIGHTS_AND_DOWNS", "LEFTS_AND_DOWNS", "LEFTS_AND_UPS", "RIGHTS_AND_UPS"}; //O-shape (starts at top, clock-wise)

    private final Pattern[] patterns = { 
        Pattern.compile(buildPatternString(forward)),
        Pattern.compile(buildPatternString(previous)),
        Pattern.compile(buildPatternString(delete)), 
        Pattern.compile(buildPatternString(vacation)), 
        Pattern.compile(buildPatternString(work)), 
        Pattern.compile(buildPatternString(school)),
        Pattern.compile(buildPatternString(family)),
        Pattern.compile(buildPatternString(selection))
    };
